...
rows = [
  ...
  [('HomeHotel', 'घर.1 · मेरा होटल › कार्ड'), ('HomeHotelRead', 'घर.1 · मेरा होटल › कार्ड से पढ़ा'), ('HomeDocs', 'घर.2 · दस्तावेज़'), ('HomeDocView', 'घर.3 · दस्तावेज़ › देखें'), ('HomePass', 'घर.4 · पास'), ('HomePassWelcome', 'घर.4 · पास आ गया')],
