...
P, R = 470, 1000
rows = [
  [('Landing', 'L · लैंडिंग'), ('Home', 'घर'), ('HomeTrial', 'घर · मुफ़्त दिन ख़त्म हो रहा, होटल नहीं'), ('HomePaid', 'घर · पास ख़रीदा')],
  [('HomeHotel', 'घर.1 · मेरा होटल'), ('HomeDocs', 'घर.2 · दस्तावेज़'), ('HomeDocView', 'घर.3 · दस्तावेज़ › देखें'), ('HomePass', 'घर.4 · पास')],
