...
const en = {
  ...
  pinPlace: 'The rider stood here on {when}. The place and the shopfront come from him.',
  changePin: 'Change',
  ...
  menuPdfFailed: 'This PDF would not open. Photograph the pages instead.',
...
const hi: Record<Key, string> = {
  ...
  pinPlace: 'रायडर {when} को यहाँ खड़ा था. जगह और दुकान की फ़ोटो उसी से आई है.',
  changePin: 'बदलें',
  ...
  menuPdfFailed: 'यह PDF नहीं खुला। पन्नों की फ़ोटो ले लीजिए।',
