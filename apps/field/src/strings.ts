...
const en = {
  ...
  pinMenuPages: 'Menu pages',
  pinMenuCount: 'Menu {n}/{max}',
  pinMenuUndo: 'Remove last page',
  pinPhotographed: 'Photographed',
  pinFromQr: 'From QR',
  pinWhatsapp: 'WhatsApp no.',
  pinNote: 'Note (optional) — e.g. WhatsApp 050… for the menu',
...
const hi: Record<Key, string> = {
  ...
  pinMenuPages: 'मेन्यू पेज',
  pinMenuCount: 'मेन्यू {n}/{max}',
  pinMenuUndo: 'आख़िरी पेज हटाएँ',
  pinPhotographed: 'फ़ोटो ली',
  pinFromQr: 'QR से',
  pinWhatsapp: 'WhatsApp नं.',
  pinNote: 'नोट (वैकल्पिक) — जैसे मेन्यू के लिए WhatsApp 050…',
