...
export const hi = {
  ...
  'landing.usp': 'दुबई में नेटवर्क नहीं चलेगा? साथी बिना इंटरनेट चलता है.',
  'landing.job1': 'नक्शा फ़ोन में',
  'landing.job2': 'हिंदी बोलिए या लिखिए',
  'landing.job3': 'अरबी दिखाइए',
  'landing.preparing': 'साथी तैयार हो रहा है…',
  'landing.preparingMinutes': 'साथी तैयार हो रहा है · {minutes} मिनट बाकी',
  'landing.ready': 'साथी तैयार है',
  'landing.gateWhy': 'पूरा होने पर ही शुरू होगा — ताकि दुबई में बिना इंटरनेट सब चले.',
  'landing.failed': 'आवाज़ वाला हिस्सा अभी नहीं आया',
  'landing.failedWhy': 'बाक़ी सब चलेगा — लिखकर पूछिए. आवाज़ बाद में वाई-फ़ाई पर आ जाएगी.',
  'landing.start': 'शुरू करें',
  'landing.noLogin': 'कोई लॉगिन नहीं. कोई अकाउंट नहीं.',

  'pass.title': 'आपका पास',
  'pass.state.before': 'दुबई पहुँचने पर शुरू होगा',
  'pass.state.trial': 'मुफ़्त दिन चल रहा है',
  'pass.state.pass': 'पास चालू है',
  'pass.state.expired': 'पास ख़त्म',
  'pass.notStarted': 'अभी कुछ नहीं घट रहा',
  'pass.over': 'समय पूरा हुआ',
  'pass.until': '{when} तक',
  'pass.rule':
    'भारत में घड़ी नहीं चलती. दुबई पहुँचते ही 24 घंटे मुफ़्त शुरू होते हैं, और पास लेने पर उसी पहुँचने से 14 दिन.',
  'pass.infoSurvives':
    'पास ख़त्म होने पर भी ज़रूरी जानकारी चालू रहेगी — होटल, दस्तावेज़ और नंबर फ़ोन में ही हैं.',
