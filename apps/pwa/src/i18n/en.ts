...
export const en: Record<StringKey, string> = {
  ...
  'nav.reach': 'Say hi',
  'reach.sayHead': 'Tell us something',
  'reach.sayWhy':
    'A place or a dish you looked for and did not find, something that was wrong, an outlet to list — write it here. We read every one.',
  'reach.name': 'Name',
  'reach.namePlaceholder': 'Your name',
  'reach.phone': 'Number',
  'reach.phonePlaceholder': 'Where a reply should go',
  'reach.country': 'Dialling code',
  'reach.india': 'India',
  'reach.uae': 'UAE',
  'reach.message': 'Your message',
  'reach.messagePlaceholder': 'Whatever you want to say, in your own language.',
  'reach.send': 'Send it',
  'reach.missing.name': 'Please put your name — we need to know who to reply to.',
  'reach.missing.phone': 'Please write the whole number — the reply comes to it.',
  'reach.missing.message': 'Please write what you wanted to say.',
  'reach.offlineNote': 'No signal — this is kept on your phone and goes the moment there is one.',
  'reach.waiting': '{count} waiting to go — they will be sent as soon as there is a signal.',
  'reach.keptHead': 'Got it',
  'reach.keptSent': 'It has reached us. The reply comes to that number.',
  'reach.keptWaiting': 'Kept on your phone. It reaches us the moment there is a signal.',
  'reach.shareHead': 'Pass it on',
  'reach.shareWhy':
    'Someone you know flying to Dubai? Send them this — it works with no internet on their phone too.',
  'reach.viaWhatsapp': 'Send on WhatsApp',
  'reach.viaAnything': 'Send some other way',
  'reach.copied': 'Link copied — paste it wherever you like.',
  'reach.shareRefused': 'The phone would not send it — the link is above, send it yourself.',
};
